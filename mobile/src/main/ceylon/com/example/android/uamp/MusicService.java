...
//import com.example.android.uamp.playback.MetadataUpdateListener;
...
//
//                    @Override
//                    public Object onMetadataRetrieveError() {
//                        mPlaybackManager.updatePlaybackState(
//                                ceylon.language.String.instance(getString(R.string.error_no_metadata)));
//                        return null;
//                    }
//
//                    @Override
//                    public Object onCurrentQueueIndexUpdated(long queueIndex) {
...
//        } else if (mMusicProvider.getInitialized()) {
//            // if music library is ready, return immediately
//            result.sendResult(mMusicProvider.getChildren(parentMediaId, getResources()));
//        } else {
//            // otherwise, only return results when the music library is retrieved
//            result.detach();
//            mMusicProvider.retrieveMediaAsync(new Callback() {
//                @Override
//                public Object onMusicCatalogReady(boolean success) {
//                    result.sendResult(mMusicProvider.getChildren(parentMediaId, getResources()));
//                    return null;
//                }
//            });
...
//
//    @Override
//    public Object onNotificationRequired() {
...
//                if (service.mPlaybackManager.getPlayback().getPlaying()) {
